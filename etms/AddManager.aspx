<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="AddManager.aspx.cs" Inherits="etms.WebForm4" %>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
   ...
   <center>   
        &nbsp;<asp:Panel ID="Panel1" runat="server" Height="256px" Width="319px" BackColor="#999999" style="margin-left: 0px">
            ...
            <br />
            &nbsp;department&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:TextBox ID="TextBox6" runat="server" Height="15px" Width="120px"></asp:TextBox>
            <br />
            &nbsp;create password&nbsp; <asp:TextBox ID="TextBox7" runat="server" Height="15px" Width="120px"></asp:TextBox>
            <br />
            <br />
            <asp:Button ID="addmngrbtn" runat="server" Text="Add Manager" OnClick="addmngrbtn_Click" />
            <br />
            <br />
            </asp:Panel>
            <asp:GridView ID="GridView1" runat="server" AllowSorting="True" AutoGenerateColumns="False" BackColor="White" BorderColor="#DEDFDE" BorderWidth="1px" CellPadding="4" DataKeyNames="user_Id" DataSourceID="SqlDataSource1" ForeColor="Black" GridLines="Vertical" Width="413px" BorderStyle="None">
